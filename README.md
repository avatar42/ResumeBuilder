...
2. Run **jhipster** and follow instructions on screen taking these options:
   ...
   - What is the base name of your application? **ResumeBuilder**
   - Do you want to make it reactive with Spring WebFlux? **No**
   - What is your default Java package name? **com.dea42.resume**
   ...
   - Please choose additional languages to install **French, German**
